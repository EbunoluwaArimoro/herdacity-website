    ...
    <section className="py-24 bg-white">
      <div className="container mx-auto px-6">
        ...
        <div className="flex items-center gap-8 mb-24">
          ...
          <h3 className="text-brand-pink font-bold uppercase tracking-[0.3em] text-sm whitespace-nowrap">
            Featured voices
          </h3>
          <div className="h-[1.5px] flex-1 bg-brand-pink opacity-30"></div>
        </div>
        ...
        <div className="flex flex-col gap-32">
          {voices.map((voice, i) => (
            ...
            >
              {/* Image Side - Exact Figma 15px radius */}
              ...
              <div className="w-full md:w-1/2 flex flex-col gap-6">
                <div className="inline-block">
                  <h4 className="text-2xl font-bold text-brand-charcoal uppercase tracking-widest inline-block border-b-2 border-brand-pink pb-1">
                    {voice.name}
                  </h4>
                  <p className="text-[10px] text-brand-charcoal/40 uppercase tracking-[0.4em] mt-3">
                    {voice.role}
                  </p>
                </div>
                
                <p className="text-xl md:text-2xl text-brand-charcoal/80 font-medium leading-relaxed font-sans">
                  {voice.story}
                </p>
              </div>
            </motion.div>
